use crate::components::ProbeLabel;
use egui::{Align2, Area, Color32, Order, Pos2, Rect, Response, RichText, Ui, Vec2};
use syncrim::common::{EguiComponent, Ports, SignalValue, Simulator};
...
#[typetag::serde]
impl EguiComponent for ProbeLabel {
    fn render(
        &self,
        ui: &mut Ui,
