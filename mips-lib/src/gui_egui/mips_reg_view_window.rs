...
pub struct RegViewWindow {
    ...
    #[serde(skip, default = "RegViewWindow::go_type_def")]
    go_type: GoAddress,
...
impl RegViewWindow {
    ...
    pub fn set_code_view(mut self, mem: Option<&MipsMem>) -> RegViewWindow {
    ...
    pub fn set_data_view(mut self, mem: Option<&MipsMem>) -> RegViewWindow {
        if let Some(m) = mem {
